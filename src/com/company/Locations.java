...
public class Locations implements Map<Integer, Location>{
    ...
    static {
        try(BufferedReader dirLocFile = new BufferedReader(new FileReader("locations_big.txt"))){
            String input;
            while ((input = dirLocFile.readLine()) != null){
            ...
            e.printStackTrace();
            System.out.println("ERROR READING THE FILE -> locations_big.txt");
        }
